...
TESTDATA_DIR = Path("tests/data/functional")
...
def asia():
    return Pandas.read(
        str(TESTDATA_DIR / "experiments/datasets/asia.data.gz"),
        dstype="categorical",
        N=100,
    )
...
# Test marginals() with no arguments - should raise TypeError
def test_pandas_marginals_type_error_1(ab2):  # no arguments specified
    with pytest.raises(TypeError):
        ab2.marginals()


# Test marginals() with invalid node parameter - should raise TypeError
...
# Test marginals() with invalid parents parameter - should raise TypeError
...
# Test marginals() with wrong parent values type - should raise TypeError
...
# Test marginals() with invalid values_reqd parameter - should raise TypeError
...
# Test marginals for orphan node A with values requested (ab2 dataset)
...
# Test marginals for orphan node A without values requested (ab2 dataset)
...
# Test marginals for orphan node B with values requested (ab2 dataset)
...
# Test marginals for node A with parent B and values requested (ab2 dataset)
...
# Test marginals for node B with parent A and values requested (ab2 dataset)
...
# Test marginals for orphan node A with values requested (ab3 dataset)
...
# Test marginals for orphan node B with values requested (ab3 dataset)
...
# Test marginals for node A with parent B and values requested (ab3 dataset)
...
# Test marginals for node B with parent A and values requested (ab3 dataset)
...
# Test marginals for orphan node A with values requested (ab8 dataset)
...
# Test marginals for orphan node B with values requested (ab8 dataset)
...
# Test marginals for node A with parent B and values requested (ab8 dataset)
...
# Test marginals for node B with parent A and values requested (ab8 dataset)
...
# Test marginals for orphan node A with values requested (abc10 dataset)
...
# Test marginals for orphan node B with values requested (abc10 dataset)
...
# Test marginals for orphan node C with values requested (abc10 dataset)
...
# Test marginals for node A with parent B and values requested (abc10 dataset)
...
# Test marginals for node A with parent C and values requested (abc10 dataset)
...
# Test marginals for node B with parent A and values requested (abc10 dataset)
...
# Test marginals for node B with parent C and values requested (abc10 dataset)
...
# Test marginals for node C with parent A and values requested (abc10 dataset)
...
# Test marginals for node C with parent B and values requested (abc10 dataset)
...
# Test marginals for node A with parents B and C and values requested (abc10)
...
# Test marginals for node B with parents A and C and values requested (abc10)
...
# Test marginals for node C with parents A and B and values requested (abc10)
...
# Test marginals for orphan node with real Asia dataset
...
# Test marginals for node with single parent using real Asia dataset
...
# Test marginals for node with two parents using real Asia dataset
...
# Test marginals for node with three parents using real Asia dataset
...
# Test marginals with modified sample size using set_N() on Asia dataset
...
# Test marginals with complex parent structure using real COVID dataset
def test_pandas_marginals_covid_1_ok():
    covid = Pandas.read(
        str(TESTDATA_DIR / "experiments/datasets/covid.data.gz"),
        dstype="categorical",
        N=1000,
    )
